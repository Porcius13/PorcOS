...
import { X, Plus, Image as ImageIcon, ArrowRight, Upload } from "lucide-react";
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-8">
      ...
      <div className="bg-white/85 dark:bg-neutral-900/85 backdrop-blur-2xl w-full max-w-2xl rounded-2xl shadow-[0_32px_64px_-12px_rgba(0,0,0,0.15)] border border-white/40 dark:border-neutral-800/40 relative z-10 flex flex-col max-h-[90vh] overflow-hidden animate-in fade-in zoom-in duration-300">
        ...
        <div className="p-8 overflow-y-auto space-y-8">
          ...
          <div className="space-y-2">
            ...
            <input 
              ...
              className="w-full bg-white/50 dark:bg-neutral-800/50 border-neutral-200 dark:border-neutral-700 rounded-xl focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 font-body text-sm py-3 px-4 outline-none transition-all dark:text-neutral-50"
            ...
            <div className="flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className={`px-4 py-1.5 rounded-full border text-xs font-medium transition-all ${
                    category === cat
                      ...
                      : "border-neutral-200 dark:border-neutral-800 text-neutral-600 dark:text-neutral-400 bg-white dark:bg-neutral-900 hover:border-amber-500 hover:text-amber-600"
                  }`}
                >
                  {cat}
                </button>
              ...
              {isAddingNew ? (
                ...
                <button 
                  ...
                  className="px-3 py-1.5 rounded-full border border-dashed border-neutral-300 dark:border-neutral-700 text-xs font-medium text-neutral-400 flex items-center gap-1 hover:border-amber-500 hover:text-amber-600 transition-all"
                >
          ...
          <div className="space-y-2">
            ...
            />
            {coverImage ? (
              <div className="relative rounded-2xl overflow-hidden group border border-neutral-200 dark:border-neutral-800 shadow-sm animate-in fade-in duration-500">
        ...
        {/* Modal Footer */}
        <div className="px-8 py-6 border-t border-neutral-100/50 dark:border-neutral-800/50 flex items-center justify-end gap-4 bg-white/40 dark:bg-black/20">
          <button 
            onClick={onClose}
            className="px-6 py-2.5 font-label text-sm font-semibold text-neutral-500 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors"
          >
            Cancel
          </button>
          <button 
            ...
            className="bg-black dark:bg-white text-white dark:text-black px-8 py-2.5 font-label text-sm font-bold rounded-xl shadow-lg shadow-black/10 hover:opacity-90 transition-all active:scale-95 flex items-center gap-2"
          >
            <span>{editItem ? "Save Changes" : "Create Research"}</span>
